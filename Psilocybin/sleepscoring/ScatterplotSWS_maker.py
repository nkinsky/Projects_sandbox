...
thresh_dict = {"Finn": {"sw": 1.0212, "theta": 0.5943, "emg": 0.0796},
               "Rose": {"sw": 1.1079, "theta": 0.48, "emg": 0.0466},
               "Rey": {"sw": 1.12, "theta": 0.5784, "emg": 0.1068},
               "Finn2": {"sw": 0.9503, "theta": 0.4994, "emg": 0.1254}}
...
for idx, (base_dir, session_type, title) in enumerate(zip(base_dirs, sessions, titles)):
    ...
    sns.scatterplot(data=metrics_df, x=x_feature, y=y_feature, ax=ax[idx], rasterized=True, alpha=0.8, s=1,
                    hue='sleepstate', palette=palette, legend=False)
